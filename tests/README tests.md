...
├── htmlcov/             # Folder containing HTML coverage reports
...
### Coverage Files
- `.coverage`: Binary data file generated by coverage.py
...
- **Features**: Coverage reporting, threshold enforcement (80% minimum)
